...
// components
import DrinkCategoryLangs from "./DrinkCategoryLangs"; // Lang Component
...
const DrinkCategoryForm = props => {
    ...
    const [status, setStatus] = useState(selectedItem?.isActive || false);
    ...
    const onSubmit = (data) => {
        ...
        if (!selectedItem?.id)
            ...
            navigationActions.update(STORE_PATHS_DRINK_CATEGORY, API_PATH_DRINK_CATEGORY, selectedItem.id, requestData, onCloseForm)
    }
...
export default DrinkCategoryForm