...
// components
import DrinkLangs from "./DrinkLangs"; // Lang Component
...
// paths
import {API_PATH_CORE_DRINK, API_PATH_CORE_MENU, API_PATH_DRINK_CATEGORY} from "../../../connection/apiPaths";
...
const DrinkForm = props => {
    ...
    const [drinkCategory, setDrinkCategory] = useState(selectedItem?.drinkCategory?.id || null)
    ...
    const onSubmit = (data) => {
        ...
        if (!selectedItem?.id)
            ...
            navigationActions.update(STORE_PATHS_CORE_DRINK, API_PATH_CORE_DRINK, selectedItem.id, requestData, onCloseForm)
    }
        ...
        <Card>
            ...
            <CardBody>
                ...
                <Row>
                    <Col>
                        <CustomSelect
                            title={'¿A qué categoría pertenece esta bebida?' }
                    ...
                    <Col>
                        <CustomSelect
                            title={'¿A qué menú pertenece esta bebida?' }
                            initialValue={menu}
