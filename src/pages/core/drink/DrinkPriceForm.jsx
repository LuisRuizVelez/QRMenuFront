...
// paths
import { STORE_PATHS_CORE_DRINK, STORE_PATH_DRINK_PRICE } from "../../../store/StorePaths";
import { API_PATH_CURRENCY, API_PATH_DRINK_PRESENTATION, API_PATH_DRINK_PRICE } from "../../../connection/apiPaths";

// actions
import navigationActions from "../../../store/navigation/navigationActions";

const DrinkPriceForm = () => {
    ...
    const onSubmit = (data) => {
        ...
        navigationActions.save(STORE_PATH_DRINK_PRICE, API_PATH_DRINK_PRICE, requestData, cleanFields)
    };
