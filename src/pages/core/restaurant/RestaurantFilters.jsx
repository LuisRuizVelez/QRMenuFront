...
const RestaurantFilters =  () => {
    ...
    const onSubmit = (data, _) => {
        ...
        dispatch(navigationSetFilter(STORE_PATHS_CORE_RESTAURANT, filterData));
    };
    ...
    return <Form onSubmit={ handleSubmit(onSubmit) }>
        <CardBody>
            <Row>
                <Col>
                    <FormGroup>
                        <label className="form-label">Código del Restaurante:</label>
                        <input
                ...
                <Col>
                    <FormGroup>
                        <label className="form-label">
                            <span>El Restaurante esta Activo:</span> <br/>
                            <Switch
                                checked={isActive}
